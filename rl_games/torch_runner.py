...
class Runner:
    ...
    def __init__(self, algo_observer=None):
        ...
        self.algo_factory.register_builder('a2c_continuous_adv', lambda **kwargs : a2c_continuous.A2CAgentAdv(**kwargs))
        ...
        self.player_factory.register_builder('a2c_continuous_adv', lambda **kwargs : players.PpoAdvPlayerContinuous(**kwargs))
